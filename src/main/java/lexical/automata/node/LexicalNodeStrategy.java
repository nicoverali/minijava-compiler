...
public interface LexicalNodeStrategy<T> {
     ...
     */
    @Nullable
    T onNoBranchSelected(SourceCodeReader reader, @NotNull CodeCharacter currentCharacter) throws LexicalException;
     ...
     */
    @Nullable
    T onEndOfFile(SourceCodeReader reader, @Nullable CodeLine currentLine) throws LexicalException;
}
