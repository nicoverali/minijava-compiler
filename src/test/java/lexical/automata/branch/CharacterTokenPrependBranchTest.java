...
class CharacterTokenPrependBranchTest {
    ...
    @InjectMocks CharacterTokenPrependBranch testSubject;

    @Test
    void delegate_decoratedReturnsToken_returnsDecoratedResultWithPrependedCharacter(){
        ...
        verify(tokenMock).prepend(charMock);
    }
    ...
    @Test
    void delegate_decoratedThrowsException_propagatesDecoratedException(){
